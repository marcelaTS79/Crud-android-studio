    ...
    Scaffold(
        topBar = {
            CenterAlignedTopAppBar(
                title = {
                    Text(text = "Control de Usuarios", color = Color.White, fontWeight = FontWeight.Bold)
                },
            ...
            items(state.listaUsuarios) {
                Box(
                    ...
                    Column(
                        ...
                        Text(text = it.documento)
                        Text(text = it.correo)
                        Text(text = it.telefono)
                        IconButton(
                            onClick = { navController.navigate("editar/${it.id}/${it.nombres}/${it.apellidos}/${it.documento}/${it.correo}/${it.telefono}") }
                        ) {
